...
export default function App(){
    ...
    const {activeMenu} = useStateContext(); // called the func to call a func to return whatever returned from useContext() hook for that context api
                ...
                <div className="flex  relative dark:bg-main-dark-bg bg-[#fafbfb]">
                    ...
                    <div className="fixed right-4 bottom-4 " style={{zIndex:'1000'}}>
                        <TooltipComponent content="Settings" position="TopCenter">
                            <button type="button" className="text-3l p-3 hover:drop-shadow-xl hover:bg-light-gray text-white" style={{background:"blue",borderRadius:'50%'}}>
                                <FiSettings/>
                            </button>
                        </TooltipComponent>
                    </div>
